/*
 Stencil Hydrate Platform v1.10.3 | MIT Licensed | https://stenciljs.com
 */
...
const initializeClientHydrate = (hostElm, tagName, hostId, hostRef) => {
    ...
    childRenderNodes.map(c => {
        ...
        const node = c.$elm$;
        if (orgLocationNode && (supportsShadow )) {
